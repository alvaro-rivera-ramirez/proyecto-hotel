document.addEventListener("DOMContentLoaded", () => {
    ...
    boton.addEventListener("click", () => {
        ...
        //         pdf.setFontSize(15);
        //         pdf.setTextColor(150);
        //         pdf.text('Hora: '+hora, (pdf.internal.pageSize.getWidth() / 9.5), (pdf.internal.pageSize.getHeight() / 1.45));
        //         pdf.text('Fecha: '+fecha, (pdf.internal.pageSize.getWidth() / 9.5), (pdf.internal.pageSize.getHeight() / 1.37));
        ...
        doc.addPage("a4","l");
        doc.text("Hola",10,10 );
        doc.fromHTML($('#TablaHabitaciones').get(0),25,5);
