const editarTipoH = () =>{
    ...
    boton_enviar.addEventListener('click', e => {
        ...
        if(vacio){
            ...
            Swal.fire({
                title: '¿Estás seguro que desea actualizar este tipo de habitacion?',
                text: "Está a punto de actualizar este tipo de habitacion",
                icon: 'warning',
                ...
                if(result.isConfirmed){
                    ...
                    //     }
                    // });
                    fetch('http://localhost/proyecto-hotel/public/actualizar_tipohab', {
                        method: 'POST',
                        mode: 'no-cors',
                        headers: {
                        ...
                        if (res['respuesta']) {
                            Swal.fire(
                            'Tipo de habitacion actualizada!',
                            '',
                            'success'
                            ).then((value) => {
                                location.reload();
