const editarHabitacion = () =>{
    ...
    boton_enviar.addEventListener('click', e => {
        ...
        if(vacio){
            ...
            Swal.fire({
                title: '¿Estás seguro que desea actualizar esta habitacion?',
                text: "Está a punto de actualizar esta habitacion",
                icon: 'warning',
                ...
                if(result.isConfirmed){
                    ...
                    //     }
                    // });
                    fetch('http://localhost/proyecto-hotel/public/actualizar_habitacion', {
                        method: 'POST',
                        mode: 'no-cors',
                        headers: {
