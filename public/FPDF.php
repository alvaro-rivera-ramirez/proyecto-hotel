...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->setXY(61,15);
        $this->Cell(88,8,'REPORTE DE USUARIOS',0,1,'C',0);
    ...
    for($i=1;$i<=30;$i++){
        ...
        $pdf->Ln(0.6);
        $pdf->setX(15);
        $pdf->Cell(7,8,$i,'B',0,'C',0);
        $pdf->Cell(30,8,'71216403','B',0,'C',0);
        $pdf->Cell(70,8,utf8_decode('Aldo Antero Centeno Maquera'),'B',0,'C',0);
        $pdf->Cell(20,8,utf8_decode('983602785'),'B',0,'C',0);
        
        $pdf->Cell(60,8,utf8_decode('aldo14az@gmail.com'),'B',1,'C',0);
