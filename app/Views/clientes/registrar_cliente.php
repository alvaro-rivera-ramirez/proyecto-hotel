...
<body>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cli_dni_reg" id="cli_dni_reg" class="validar">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cli_nombre_reg" id="cli_nombre_reg" class="validar">
                                            <p class="d-none text-danger validacion"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="cli_apellidop_reg" class="bmd-label-floating">Apellido
                                                Paterno</label>
                                            <input type="text" name="cli_apellidop_reg" id="cli_apellidop_reg" class="validar">
                                            <p class="d-none text-danger validacion"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="cli_apellidom_reg" class="bmd-label-floating">Apellido
                                                Materno</label>
                                            <input type="text" name="cli_apellidom_reg" id="cli_apellidom_reg" class="validar">
                                            <p class="d-none text-danger validacion"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cli_telefono_reg" id="cli_telefono_reg" class="validar">
                                            <p class="d-none text-danger validacion"></p>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 pt-4">
                                <div class="d-flex">
                                    <div class="w-100 d-flex justify-content-end">
                                        <button type="button" class="btn-guardar" id="guardar_cliente">
                                            Guardar
                                        </button>
                                    </div>
                                </div>
    ...
    <script src="js/clientes/nuevoCliente.js"></script>
    <script>
    // let boton_enviar = document.getElementById('guardar_cliente');
