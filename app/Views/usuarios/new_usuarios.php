        ...
        <div class="w-100" style="background-color: #F1F3F5">
            ...
            <div class="ps-2 pt-3 content-body">
                <div class="content p-5" style="background: white;">
                    ...
                    <div class="container-fluid">
                        <form id="form_usu" action="" class="row g-3" autocomplete="off"
                            method="post">
                            <fieldset>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <p class="d-none text-danger" id="validacion9" >Seleccione una opción por favor</p>                                             
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        boton_enviar.addEventListener('click', e => {
            ...
            if (val1.value === '' || val1.value === null || val2.value === '' || val2.value === null || val3.value === '' ||
                ...
                val6.value === '' || val6.value === null || val7.value === '' || val7.value === null || val8.value === '' || 
